...
""")
    st.markdown("""GPU utilization values:
* sm_util: % of time one or more kernels was executing on the GPU
* tc_util: % of compute time using Tensor Core
* vram_io: % of time GPU memory was being read or written""")
